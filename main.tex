...
\begin{figure}[h]
    \centering
    \includegraphics[width=1.0\textwidth]{images/isotrpy.png}
    \caption{Isotropical etching. The etch rate from the mask opening is similar in all directions.}
    \label{fig:isotropy}
\end{figure}
\newline
\newline
...
To improve the film adhesion activation step was altered. Different concentrations (2$\-$5):1 was tried with varying activation times (30 min $\-$ 1h), but they did not alter the outcome on an observable level. The piranha treatment was altered to last 30 min, then a thorough rinse (over 30 s) in $\mathrm{dH_20}$ and putting it back to the piranha (cool) solution for 10 min. The chips were then again thoroughly rinsed and put in $\mathrm{dH_2 0}$. This was done to increase hydroxyl groups on the surface and to rinse any contaminants. Careless cleaning of piranha residues from the chip leads to disastrous results (Figure \ref{fig:bad_piranha}). Prior to evaporation the chips were put on a hotplate at $\SI{130}{\celsius}$ for 2 min to evaporate all moisture. Higher temperatures were avoided to avoid the desorption of the carboxyl groups.

\begin{figure}
    \centering
    \includegraphics[width=1.0\textwidth]{optical/bad_piranha.png}
    \caption{Pirahna residue under mask layer.}
    \label{fig:bad_piranha}
\end{figure}
...
\begin{figure}[h]
    ...
    \begin{subfigure}{0.48\textwidth}
        ...
        \caption{Focus within pinhole} \label{fig:pinholeee}
    \end{subfigure}
...
\begin{figure}
    ...
    \begin{subfigure}[ht]{0.48\textwidth}
        ...
        \caption{Unwanted etch of sharp features} \label{fig:lell}
    \end{subfigure}
...
\begin{figure}
    ...
    \begin{subfigure}[ht]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{optical/underetch02.png} 
        \caption{} \label{fig:lellqqq}
    \end{subfigure}
    \caption{Overetching of Cr under Au mask. Images taken from the bottom of the chip. 1) The fast underetching of Cr ruined the electrodes. 2) Thensile stress visible when the gold mask is peeling upwards after channel etch.} \label{fig:underetch}
\end{figure}  
...
\begin{enumerate}
    ...
    \item Thermal endurance; not melting and retaining conductivity after being subjected for 590*C in TADB Can be soldered to connecting wires
...
\begin{table}[h]
 ...
 \begin{figure}
    ...
    \begin{subfigure}[ht]{0.48\textwidth}
        ...
        \caption{} \label{fig:lellqqq}
    \end{subfigure}
    \caption{1) Electrodes detaching from glass due to bad adhesion. 2) HF etched the protective $\mathrm{SiO_2}$ layer through a pinhole, which lead to pirahna corroding the gold.} \label{fig:eleproblem}
\end{figure}  
...
\newline
Ideaalikaasun tilanyhtälön mukaan on komponentin $i$ osatiheys lil
%
\begin{equation}
